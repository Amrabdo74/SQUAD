...
import logo from '../assets/images/najez_logo.webp'
                ...
                <div className="col-12 col-sm-12 col-md-6 col-lg-3">
                    <div className="bord_side">
                        ...
                        <div className="d-flex mt-2 flex-column gap-2 footer-text py-2 p-0">
                                <Link rel="nofollow" className="d-flex gap-2 align-items-center text-decoration-none text-dark " to="tel:+201155272634" >
                                    <div className="contact_icon px-2 py-1">
                                    <FaPhoneSquareAlt />
                                    </div>
                                    <span>01155272634</span>
                                </Link>
                                <Link rel="nofollow" className="d-flex gap-2 align-items-center text-decoration-none text-dark " to="mailto:info@najezsoft.com" >
                                    <div className="contact_icon px-2 py-1">
                                    <FaEnvelope />
                                    </div>
                                    <span>info@najezsoft.com</span>
                                </Link>
                                <Link 
  rel="nofollow" 
  target='_blank'  
