...
import services from "../assets/images/ERP2.png";
...
import serv from "../assets/images/ERP.jpg";
import NavPage from "../components/NavPage";
import SEO from "../components/SEO";
import React from 'react';

const SingleService3 = () => {
                    ...
                    <div className="row">
                        <div className="col-sm-12 col-md-8">
                            ...
                            <div className="secvice-text mb-5">
                                <h3 className="secvice-hed secvice-custm" data-aos="flip-up" > {t("m3_service-2")}</h3>
                                <ul className="benfits-des" data-aos="flip-up" >
                                    <li>{t("m3_service-2_desc1")}</li>
                                    <li>{t("m3_service-2_desc2")}</li>
                                    <li>{t("m3_service-2_desc3")}</li>
                                    <li>{t("m3_service-2_desc4")}</li>
                                    <li>{t("m3_service-2_desc5")}</li>
                                    <li>{t("m3_service-2_desc6")}</li>
                            ...
                            <div className="secvice-text mb-5">
                                <h3 className="secvice-hed " data-aos="flip-up" >{t("m3_service-3")}</h3>
                                <img
                                    src={serv}
                                ...
                                <ul className="benfits-des" data-aos="flip-up">
                                    <li>{t("m3_service-3_desc1")}</li>
                                    <li>{t("m3_service-3_desc2")}</li>
                                    <li>{t("m3_service-3_desc3")}</li>
                                    <li>{t("m3_service-3_desc4")}</li>
