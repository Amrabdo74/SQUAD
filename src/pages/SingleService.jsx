...
import services from "../assets/images/webb.png";
                    ...
                    <div className="row">
                        <div className="col-sm-12 col-md-8">
                            ...
                            <div className="secvice-text mb-5">
                                <h3 className="secvice-hed secvice-custm" data-aos="flip-up" > {t("m1_service-2")}</h3>
                                <ul className="benfits-des" data-aos="flip-up" >
                                    <li>{t("m1_service-2_desc1")}</li>
                                    <li>{t("m1_service-2_desc2")}</li>
                                    <li>{t("m1_service-2_desc3")}</li>
                                    <li>{t("m1_service-2_desc4")}</li>
                            ...
                            <div className="secvice-text mb-5">
                                <h3 className="secvice-hed " data-aos="flip-up" >{t("m1_service-3")}</h3>
                                <img
                                    src={serv}
                                ...
                                <ul className="benfits-des" data-aos="flip-up">
                                    <li>{t("m1_service-3_desc1")}</li>
                                    <li>{t("m1_service-3_desc2")}</li>
                                    <li>{t("m1_service-3_desc3")}</li>
                                    <li>{t("m1_service-3_desc4")}</li>
                                    <li>{t("m1_service-3_desc5")}</li>
